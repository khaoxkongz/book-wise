  ...
  return (
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      <div className="flex flex-col items-start gap-2">
        <h1 className="text-2xl font-bold">Welcome Back to the BookWise</h1>
        <p className="text-sm text-[#D6E0FF]">Access the vast collection of resources, and stay updated</p>
      </div>
      ...
      <div className="text-center text-sm">
        ...
        <Link to="/register" className="font-bold text-[#E7C9A5] underline underline-offset-4">
          Register
        </Link>
      </div>
    </form>
